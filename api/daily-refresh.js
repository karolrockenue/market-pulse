...
// add this line at the top if it's not there
    ...
    for (const hotel of allHotels) {
      ...
      if (pms_type === "mews") {
        try {
          ...
          // Safely handle potentially empty API responses
          const occupancyMetrics = occupancyData.dailyMetrics[0] || {};
          const revenueMetrics = revenueData.dailyMetrics[0] || {};

          const rooms_sold = occupancyMetrics.occupied || 0;
          const capacity_count = occupancyMetrics.available || 0;
          const net_revenue = revenueMetrics.netRevenue || 0;
          const gross_revenue = revenueMetrics.grossRevenue || 0;
