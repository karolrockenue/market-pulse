          ...
          <div className="grid grid-cols-3 gap-4">
            {tools.filter(t => t.active).map((tool) => {
              ...
              return (
                ...
                {/* [FIX] Replaced failing opacity modifiers with inline styles for static CSS build */}
<div 
  className="w-11 h-11 rounded-lg flex items-center justify-center group-hover:bg-[#faff6a]/20 transition-all"
  style={{
    backgroundColor: 'rgba(250, 255, 106, 0.1)', // This is bg-[#faff6a]/10
    borderColor: 'rgba(250, 255, 106, 0.3)' // This is border-[#faff6a]/30
  }}
>
