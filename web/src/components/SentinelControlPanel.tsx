...
<div style={{ minHeight: '100vh', background: '#1d1d1c', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 10, padding: '3rem', maxWidth: '1800px', margin: '0 auto' }}>
        ...
        {/* --- [MODIFIED] Section 1: Rate Certification (Wired-Up) --- */}
        <div style={{ marginBottom: '2rem' }}>
          <Card style={{ backgroundColor: '#1a1a1a', borderColor: '#2a2a2a' }}> {/* <-- [MODIFIED] Added inline style */}
            <CardHeader>
<CardTitle 
  style={{ 
    color: '#e5e5e5', 
...
>
  <PlayCircle style={{ width: '1.25rem', height: '1.25rem', color: '#39BDF8' }} />
  Cloudbeds Certification Tester
</CardTitle>
  <CardDescription style={{ color: '#9ca3af' }}>
    Test rate updates directly to Cloudbeds PMS API
  </CardDescription>
</CardHeader>
            <CardContent style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  <Label htmlFor="property-id" className="text-[#9ca3af] text-xs uppercase tracking-wider">
                    Property ID
                  </Label>
                  <div style={{ display: 'flex', gap: '0.5rem' }}>
                    <Input
                      ...
                      placeholder="e.g., 302817"
                      style={{ backgroundColor: '#0f0f0f' }} // <-- [FIX]
                      className="border-[#2a2a2a] text-[#e5e5e5] focus:border-[#39BDF8]/50"
                    />
                    <Button
                      onClick={handleFetchRatePlans}
                      disabled={!propertyId || isFetchingPlans}
                      style={{ backgroundColor: '#39BDF8', color: '#0f0f0f' }} // <-- [FIX]
                      variant="outline"
                      size="icon"
...
<div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
  ...
  <Input
    ...
    placeholder="Find w/ Fetch ->"
    style={{ 
      backgroundColor: '#0f0f0f',
      borderColor: '#2a2a2a', 
      color: '#e5e5e5'
    }}
    className="focus:border-[#39BDF8]/50" // Note: focus will not work
  />
</div>
<div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
  <Label 
...
<div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
  ...
  />
              ...
              <div>
       <Button
  onClick={handleTestPostRate}
  disabled={!propertyId || !rateId || !date || !rate || isTestingRate}
  style={{ backgroundColor: '#39BDF8', color: '#0f0f0f' }}
  className="disabled:opacity-50 disabled:cursor-not-allowed"
>
  <PlayCircle style={{ width: '1rem', height: '1rem', marginRight: '0.5rem' }} />
  {isTestingRate ? 'Testing...' : 'Test postRate'}
</Button>
              </div>
 ...
 <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', maxWidth: '400px' }}>
  ...
  disabled={!jobId || !propertyId || isCheckingStatus}
  style={{ 
    backgroundColor: '#faff6a', 
    color: '#0f0f0f', 
    borderColor: '#faff6a' // Added border
  }}
  variant="outline"
>
  ...
  <div style={{ position: 'relative' }}>
    <Textarea
      value={apiResponse}
      readOnly
      placeholder="1. Enter Property ID and click 'Search' to find a Rate ID.&#10;2. Copy-paste the Rate ID, fill in Date and Rate, then click 'Test postRate'.&#10;3. Click 'Check Status' to confirm.&#10;Response will appear here..."
      style={{ 
        backgroundColor: '#0f0f0f',
        borderColor: '#2a2a2a',
        color: '#10b981',
...
<AccordionItem 
              ...
              {/* [FIX] This is the correct, clean AccordionTrigger */}
                <AccordionTrigger 
                  ...
                  onClick={() => setPropertyId(String(hotel.pms_property_id))}
                  style={{ 
