...
function OnboardingOverlay({
  ...
  return createPortal(
    <div style={{
      position: "fixed", inset: 0, backgroundColor: "#1d1d1c",
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px", justifyContent: "center", marginBottom: "6px" }}>
                ...
                <span style={{ color: "#e5e5e5", fontSize: "16px", fontWeight: 600 }}>
                  {testResult.propertyName}
                </span>
              </div>
              <div style={{ color: "#9ca3af", fontSize: "12px", display: "flex", gap: "16px", justifyContent: "center" }}>
            ...
            <div style={{ textAlign: "left", marginBottom: "24px" }}>
              <label style={{ color: "#9ca3af", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.05em", display: "block", marginBottom: "10px" }}>
                Accommodation Service {testResult.services.length > 1 && `(${testResult.services.length} found)`}
              </label>
              {testResult.services.length === 1 ? (
                <div style={{
                  color: "#e5e5e5", fontSize: "13px", padding: "10px 14px",
                  backgroundColor: "rgba(57, 189, 248, 0.1)", border: "1px solid #39BDF8",
                  borderRadius: "6px",
                }}>
                  ...
                  {testResult.services.map((svc) => (
                    <label
                      ...
                      style={{
                        ...
                        padding: "10px 14px",
                        backgroundColor: selectedServiceId === svc.id ? "rgba(57, 189, 248, 0.1)" : "#1a1a1a",
            ...
            <Button
              ...
              style={{
                ...
                backgroundColor: selectedServiceId && !isOnboarding ? "#39BDF8" : "#2a2a2a",
                color: selectedServiceId && !isOnboarding ? "#0d0d0d" : "#6b7280",
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ marginBottom: "32px", display: "flex", justifyContent: "center" }}>
              <div style={{ position: "relative", width: "96px", height: "96px" }}>
                <div className="animate-spin" style={{
                  ...
                  border: "3px solid #2a2a2a", borderTopColor: "#39BDF8", borderRadius: "50%",
                }} />
                <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <CurrentSyncIcon style={{ width: "36px", height: "36px", color: "#39BDF8" }} />
                </div>
              </div>
            </div>

            <h1 style={{ color: "#e5e5e5", fontSize: "22px", fontWeight: 600, marginBottom: "12px", letterSpacing: "-0.025em" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "10px" }}>
                ...
                <span style={{ color: "#39BDF8", fontSize: "11px" }}>Step {syncStep + 1} of {syncSteps.length}</span>
              </div>
              <div style={{ width: "100%", backgroundColor: "#0d0d0d", borderRadius: "4px", height: "6px", marginBottom: "14px" }}>
                <div style={{
                  backgroundColor: "#39BDF8", height: "6px", borderRadius: "4px",
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px", justifyContent: "center" }}>
                ...
                <span style={{ color: "#e5e5e5", fontSize: "13px" }}>{syncSteps[syncStep].text}</span>
              </div>
            </div>
            ...
            <div style={{ marginTop: "28px" }}>
              ...
              <div style={{ color: "#6b7280", fontSize: "11px" }}>Expected completion: 2-5 minutes</div>
            </div>
          </div>
        )}
        ...
        {step === "classify" && (
          <div style={{ textAlign: "center" }}>
            <div style={{ marginBottom: "24px" }}>
              ...
              <h1 style={{ color: "#e5e5e5", fontSize: "22px", fontWeight: 600, marginBottom: "8px" }}>
                ...
                return (
                  ...
                  >
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "8px" }}>
                      <Icon style={{ width: "28px", height: "28px", color: isSelected ? "#39BDF8" : "#6b7280" }} />
                      <div>
                        <div style={{ fontSize: "12px", fontWeight: 600, color: isSelected ? "#39BDF8" : "#e5e5e5", marginBottom: "2px" }}>
                          {tier.name}
                        </div>
            ...
            <div style={{ display: "flex", gap: "12px", justifyContent: "center" }}>
              <button
                ...
                style={{ background: "none", border: "none", color: "#6b7280", fontSize: "13px", cursor: "pointer", padding: "10px 20px" }}
              >
                Skip for now
              </button>
              <Button
                ...
                style={{
                  ...
                  backgroundColor: "#39BDF8", color: "#0d0d0d", border: "none",
                }}
              >
...
export function MewsOnboarding() {
  ...
  return (
    <>
      <div style={{ backgroundColor: "#1a1a1a", border: "1px solid #2a2a2a", borderRadius: "0.5rem" }}>
        <div style={{ padding: "24px", paddingBottom: "0" }}>
          <h3 style={{
            color: "#e5e5e5", fontSize: "1.25rem",
        ...
        <div style={{ padding: "24px", display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          {status !== "tested" ? (
            <Button
              ...
              style={{
                backgroundColor: "#39BDF8", color: "#0f0f0f",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              <Button
                ...
                style={{ backgroundColor: "#10b981", color: "#0f0f0f" }}
